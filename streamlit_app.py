...
# ==========================================
# 4. XỬ LÝ KHI BẤM NÚT TẠO FILE
# ==========================================
if submit_btn:
    with st.spinner("Đang xử lý dữ liệu..."):
        # Gọi hàm tạo PDF
        pdf_file = generate_be_pdf(study_code, num_subjects, num_timepoints, num_periods)
        
        st.success("✅ Đã tạo thành công! Bấm nút bên dưới để tải về.")
        
        # Nút Download hiện ra sau khi xử lý xong
        st.download_button(
            label="⬇️ TẢI FILE PDF VỀ MÁY",
            data=pdf_file,
            file_name=f"Nhan_{study_code}_{num_periods}Periods.pdf",
